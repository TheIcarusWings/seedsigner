...
class SettingsConstants:
    ...
    DISPLAY_CONFIGURATION__DPI28__480x640 = "dpi28_480x640"  # Waveshare 2.8" DPI touchscreen (rendered at the panel's native 480x640)
    ALL_DISPLAY_CONFIGURATIONS = [
        ...
        (DISPLAY_CONFIGURATION__DPI28__480x640, "dpi28 480x640 touch"),
    ]
